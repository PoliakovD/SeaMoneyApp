...
/// <summary>
/// Сервис для настройки глобального логирования с использованием Splat.
/// </summary>
public static class LoggerSetup
{
    /// <summary>
    /// Настраивает логгер Splat с записью в файл. LoggerSetup.SetupLogger(LogLevel level);
    ...
    /// <summary>
    /// Кастомная реализация ILogger, записывающая логи в файл.
    /// </summary>
    private class FileLogger : ILogger
    {
        private readonly string _logPath;

        // Уровень логирования — можно настроить, но пока логируем всё
